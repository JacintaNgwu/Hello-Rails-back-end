...
```sh
   git clone https://github.com/JacintaNgwu/Hello-Rails-back-end.git
```
...
Feel free to check the [issues page](https://github.com/JacintaNgwu/Hello-Rails-bac-end/issues).
